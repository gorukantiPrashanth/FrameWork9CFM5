...
public class RegisterShopperTest extends  BaseClass {
	...
	public void createAccountTest() throws InterruptedException {
		...
		String pwd = map.get("Password")+ randomNum;
				signUp.createAccount(map.get("First Name"),map.get("Last Name"), map.get("Gender"), map.get("Phone Number"),map.get("Email Address"),map.get("Password"));
		Thread.sleep(4000);
		welcome.clickLoginButton();
		login.logininToApp(email,pwd);
		Thread.sleep(2000);
